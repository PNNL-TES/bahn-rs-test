...
# log tramsfor
srdb_orig$Rs_annual_log <- log(srdb_orig$Rs_annual)
srdb_orig$Rs_annual_bahn_log <- log(srdb_orig$Rs_annual_bahn)
...
print(bahn_vs_new (srdb_orig, 'Rs_annual_bahn_log', var_title = 'Bahn (2010)', res_title = 'Residual plot')) 
```
...
for( i in c( 6, 4, 2, 1, 0.5, 0.25 ) ) {
  ...
  m <- lm(Rs_annual_log ~ Rs_annual_bahn_log, data = dat)
...
for (i in 1:length (var_eco)) {
  ...
  lm_mv <- lm(Rs_annual_log ~ Rs_annual_bahn_log  , data = srdb_mv_eco) #unique(srdb_mv_eco$Ecosystem_type)
  ...
  lm_kp <- lm(Rs_annual_log ~ Rs_annual_bahn_log  , data = srdb_kp_eco)
...
Rs_annual_bahn_test(srdb_mv_ag, 'Rs_annual_bahn_log', var_title = 'Rs_annual vs Rs_annual_bahn', res_title = 'Residual plot')
...
Rs_annual_bahn_test(srdb_kp_ag, 'Rs_annual_bahn_log', var_title = 'Rs_annual vs Rs_annual_bahn', res_title = 'Residual plot')
...
Rs_annual_bahn_test(srdb_mv_wet, 'Rs_annual_bahn_log', var_title = 'Rs_annual vs Rs_annual_bahn', res_title = 'Residual plot')
...
Rs_annual_bahn_test(srdb_kp_wet, 'Rs_annual_bahn_log', var_title = 'Rs_annual vs Rs_annual_bahn', res_title = 'Residual plot')
```
...
Rs_annual_bahn_test(srdb_mv_IRGA, 'Rs_annual_bahn_log', var_title = 'Rs_annual vs Rs_annual_bahn', res_title = 'Residual plot')

# Alkaline method
srdb_kp_IRGA <- filtration_mk ( srdb_orig, fil_type = srdb_orig$Meas_method
                               , var = c( "IRGA", "Gas chromatography", "Gas Chromatography" ), mk = F )
Rs_annual_bahn_test(srdb_kp_IRGA, 'Rs_annual_bahn_log', var_title = 'Rs_annual vs Rs_annual_bahn', res_title = 'Residual plot')
...
Q10_test(srdb_v4, 'Q10_0_10', 'Test Q10 (0-10) for Ra and Rh dominate sites')
Q10_test(srdb_v4, 'Q10_5_15', 'Test Q10 (5-15) for Ra and Rh dominate sites')
R10_test(srdb_v4, 'Q10_10_20', 'Test Q10 (10-20) for Ra and Rh dominate sites')
Q10_test(srdb_v4, 'Q10_0_20', 'Test Q10 (0-20) for Ra and Rh dominate sites')
```

```{r R10 test}
# test Q10 under Ra and Rh dominant sites
R10_test(srdb_v4, 'R10', 'Test R10 for Ra and Rh dominate sites')
# R10_test(srdb_v4, 'R10_0_10', 'Test R10 (0-10) for Ra and Rh dominate sites')
# R10_test(srdb_v4, 'R10_5_15', 'Test R10 (5-15) for Ra and Rh dominate sites')
# R10_test(srdb_v4, 'R10_10_20', 'Test R10 (10-20) for Ra and Rh dominate sites')
# R10_test(srdb_v4, 'R10_0_20', 'Test R10 (0-20) for Ra and Rh dominate sites')
```
...
print( summary( lm( Rs_annual ~ Rs_annual_bahn_log * Biome, data=srdb ) ) )
p <- ggplot( srdb_orig, aes( Rs_annual_bahn_log, Rs_annual_log, color= Biome) )
...
for (i in 1:length (var_filt)) {
  ...
  lm_mv <- lm(Rs_annual_log ~ Rs_annual_bahn_log  , data = srdb_mv_filt) #unique(srdb_mv_filt$Biome)
  R2_mv <- round(summary(lm_mv)$r.squared, 2)
  slope_mv <- round(lm_mv$coefficients[2], 2)
  ...
  lm_kp <- lm(Rs_annual_log ~ Rs_annual_bahn_log  , data = srdb_kp_filt)
  R2_kp <- round(summary(lm_kp)$r.squared, 2)
  slope_kp <- round(lm_kp$coefficients[2], 2)
...
srdb_orig$Rs_annual_bahn_new1_log <- log(srdb_orig$Rs_annual_bahn_new1)
bahn_new1 <- bahn_vs_new (srdb_orig, 'Rs_annual_bahn_new1_log', var_title = 'Bahn (new1)', res_title = 'Residual plot')
print (bahn_new1)
```
...
# plot results
srdb_orig$Rs_annual_bahn_new2_log <- log(srdb_orig$Rs_annual_bahn_new2)
bahn_new2 <- bahn_vs_new (srdb_orig, 'Rs_annual_bahn_new2_log', var_title = 'Bahn (SPI_PDSI)', res_title = 'Residual plot')
print (bahn_new2)
```
...
bahn2010 <- bahn_vs_new (srdb_orig, 'Rs_annual_bahn_log', var_title = 'Bahn (2010)', res_title = 'Residual plot')
bahn_new1 <- bahn_vs_new (srdb_orig, 'Rs_annual_bahn_new1_log', var_title = 'Bahn (new1)', res_title = 'Residual plot')
bahn_new2 <- bahn_vs_new (srdb_orig, 'Rs_annual_bahn_new2_log', var_title = 'Bahn (SPI_PDSI)', res_title = 'Residual plot')
...
# TAnnual, function 
srdb_orig$Rs_annual_bahn_TAnnual_log <- log(srdb_orig$Rs_annual_bahn_TAnnual)
bahn_new2_TAnnual <- bahn_vs_new (srdb_orig, 'Rs_annual_bahn_TAnnual_log', var_title = 'Bahn (new1)', res_title = 'Residual plot')
srdb_orig$Rs_annual_bahn_MAT_log <- log(srdb_orig$Rs_annual_bahn_MAT)
bahn_new2_MAT <- bahn_vs_new (srdb_orig, 'Rs_annual_bahn_MAT_log', var_title = 'Bahn (SPI_PDSI)', res_title = 'Residual plot')
...
```{r}
# remove outliers
Outlier_test(srdb_orig, 'Rs_annual_bahn_TAnnual_log', var_title = 'Bahn (new1)', res_title = 'Residual plot')
```
...
srdb_orig$Rs_annual_bahn_TAnnual_adj_log <- log(srdb_orig$Rs_annual_bahn_TAnnual_adj) 
bahn_new2_TAnnual_adj <- bahn_vs_new (srdb_orig, 'Rs_annual_bahn_TAnnual_adj_log', var_title = 'Bahn (new1)', res_title = 'Residual plot')
srdb_orig$Rs_annual_bahn_MAT_adj_log <- log(srdb_orig$Rs_annual_bahn_MAT_adj) 
bahn_new2_MAT_adj <- bahn_vs_new (srdb_orig, 'Rs_annual_bahn_MAT_adj_log', var_title = 'Bahn (SPI_PDSI)', res_title = 'Residual plot')
...
srdb_orig$Rs_annual_bahn_TAnnual_maat_log <-log(srdb_orig$Rs_annual_bahn_TAnnual_maat)
bahn_new2_maat_TAnnual <- bahn_vs_new (srdb_orig, 'Rs_annual_bahn_TAnnual_maat_log', var_title = 'Bahn (new3_amat)', res_title = 'Residual plot')
srdb_orig$Rs_annual_bahn_MAT_maat_log <-log(srdb_orig$Rs_annual_bahn_MAT_maat)
bahn_new2_maat_MAT <- bahn_vs_new (srdb_orig, 'Rs_annual_bahn_MAT_maat_log', var_title = 'Bahn (mew3_mat)', res_title = 'Residual plot')
