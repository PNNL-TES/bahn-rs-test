...
* We tested the affect of preipitation and temperature variability (quantified by standard diviation from 1961 to 2014), using multiple linear regression, with divergence as chatergorical indicator, and the results also support that precipitation and temperature divergence have no significant effect on the Rs_annual_bahn vs Rs_annual relationship.
...
Rs_annual_bahn_test(srdb_mv_ag, 'Rs_annual_bahn_log', var_title = 'Agriculture sites removed', res_title = 'Residual plot')
...
Rs_annual_bahn_test(srdb_kp_ag, 'Rs_annual_bahn_log', var_title = 'Only agriculture sites', res_title = 'Residual plot')
...
Rs_annual_bahn_test(srdb_mv_wet, 'Rs_annual_bahn_log', var_title = 'Wetland sites removed', res_title = 'Residual plot')
...
Rs_annual_bahn_test(srdb_kp_wet, 'Rs_annual_bahn_log', var_title = 'Only wetland sites', res_title = 'Residual plot')
```
...
Rs_annual_bahn_test(srdb_mv_IRGA, 'Rs_annual_bahn_log', var_title = 'Alkali measured sites', res_title = 'Residual plot')

# Alkaline method
srdb_kp_IRGA <- filtration_mk ( srdb_orig, fil_type = srdb_orig$Meas_method
                               , var = c( "IRGA", "Gas chromatography", "Gas Chromatography" ), mk = F )
Rs_annual_bahn_test(srdb_kp_IRGA, 'Rs_annual_bahn_log', var_title = 'IRGA and GC measured sites', res_title = 'Residual plot')
...
```{r}
# remove outliers
Outlier_test(srdb_orig, 'Rs_annual_bahn_TAnnual_log', var_title = 'Bahn (new1)', res_title = 'Residual plot', var_outlier = 0.5)
```
