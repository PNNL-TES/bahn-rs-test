...
```{r, results='hide', message=TRUE, include=TRUE, echo=FALSE, warning=FALSE, fig.height = 5, fig.width = 7}
...
```{r, , results='hide', message=TRUE, include=TRUE, warning=FALSE, echo=FALSE, fig.height = 5, fig.width = 7}
...
```{r agriculture, results='hide', message=TRUE, include=TRUE, warning=FALSE, echo=FALSE, fig.height = 5, fig.width = 7}
...
```{r wetland, results='hide', message=TRUE, include=TRUE, warning=FALSE, echo=FALSE, fig.height = 5, fig.width = 7}
...
```{r, results='hide', message=TRUE, include=TRUE, echo=FALSE, fig.width=5, fig.height = 8}
