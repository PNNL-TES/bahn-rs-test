...
```{r}
p1 <- qplot( MAT_Del, MAT,  data=srdb ) + geom_abline( slope=1, linetype = "dotdash", size = 1.5, col = "red") + geom_smooth( method='lm' )
print( p1 )

p2 <- qplot( TAnnual_Del, Study_temp, data=srdb ) + geom_abline( slope=1, linetype = "dotdash", size = 1.5, col = "red") + geom_smooth( method='lm' )
print( p2 )

p3 <- qplot( MAP_Del, MAP, data=srdb ) +  geom_abline( slope=1, linetype = "dotdash", size = 1.5, col = "red") + geom_smooth( method='lm' )
print( p3 )

p4 <- qplot( PAnnual_Del, Study_precip, data=srdb ) +  geom_abline( slope=1, linetype = "dotdash", size = 1.5, col = "red") + geom_smooth( method='lm' )
print( p4 )
...
```{r filtration_mk, fig.height = 8, fig.width = 5}
